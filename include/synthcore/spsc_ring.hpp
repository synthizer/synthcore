...
/**
 * An SpscRing is a ringbuffer modelled after the DirectSound API. You tell it how many samples you want, and it gives
 * you a pair of pointers and lengths. You write to both lengths, then tell it you're done.
 * */
