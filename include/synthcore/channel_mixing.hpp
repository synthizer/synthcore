...
/*
 * Mix a specified length of audio from in with inChannelCount to out with
 * outChannelCount.
 *
 * This function is used to handle i.e. generator processing for mono to stereo,
 * etc.
 *
 * As is the synthcore convention, this adds to output, not replaces.
 * */
